# Source: https://rasa.com/docs/reference/channels/facebook-messenger

On this page

## Facebook Setup[​](https://rasa.com/docs/reference/channels/facebook-messenger/#facebook-setup 'Direct link to Facebook Setup')
...
### Getting Credentials[​](https://rasa.com/docs/reference/channels/facebook-messenger/#getting-credentials 'Direct link to Getting Credentials')
...
6. Set up a **Webhook** and select at least the **messaging** and **messaging\_postback** subscriptions. Insert your callback URL, which will look like `https://<host>:<port>/webhooks/facebook/webhook`, replacing the host and port with the appropriate values from your running Rasa server.
...
Facebook Messenger only forwards messages to endpoints via `https`, so take appropriate measures to add it to your setup. For local testing of your bot, see [Testing Channels on Your Local Machine](https://rasa.com/docs/reference/channels/messaging-and-voice-channels/#testing-channels-on-your-local-machine).

For more detailed steps, visit the [Messenger docs](https://developers.facebook.com/docs/graph-api/webhooks).

### Running On Facebook Messenger[​](https://rasa.com/docs/reference/channels/facebook-messenger/#running-on-facebook-messenger 'Direct link to Running On Facebook Messenger')
...
## Supported response attachments[​](https://rasa.com/docs/reference/channels/facebook-messenger/#supported-response-attachments 'Direct link to Supported response attachments')
...
- [Facebook Setup](https://rasa.com/docs/reference/channels/facebook-messenger/#facebook-setup)
 - [Getting Credentials](https://rasa.com/docs/reference/channels/facebook-messenger/#getting-credentials)
 - [Running On Facebook Messenger](https://rasa.com/docs/reference/channels/facebook-messenger/#running-on-facebook-messenger)
- [Supported response attachments](https://rasa.com/docs/reference/channels/facebook-messenger/#supported-response-attachments)