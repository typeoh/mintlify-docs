# Source: https://rasa.com/docs/reference/channels/telegram

On this page

You first have to create a Telegram bot to get credentials. Once you have them you can add these to your `credentials.yml`.

## Getting Credentials[​](https://rasa.com/docs/reference/channels/telegram/#getting-credentials 'Direct link to Getting Credentials')

**How to get the Telegram credentials:** You need to set up a Telegram bot.

1. To create the bot, go to [Bot Father](https://web.telegram.org/#/im?p=@BotFather), enter `/newbot` and follow the instructions. The URL that Telegram should send messages to will look like `http://<host>:<port>/webhooks/telegram/webhook`, replacing the host and port with the appropriate values from your running Rasa server.
...
## Running on Telegram[​](https://rasa.com/docs/reference/channels/telegram/#running-on-telegram 'Direct link to Running on Telegram')
...
At the beginning of a conversation, the user will press the 'Start' button in Telegram. This will trigger a message with the content _/start_ to be sent. Make sure your bot can handle this intro message by designing a specific intent in the nlu training data file. Then add this `start` intent to the domain alongside a story or rule to handle it.

## Supported Response Attachments[​](https://rasa.com/docs/reference/channels/telegram/#supported-response-attachments 'Direct link to Supported Response Attachments')
...
```
  utter_giraffe_sticker:  - text: Here's my giraffe sticker!    custom:      sticker: "https://github.com/TelegramBots/book/raw/master/src/docs/sticker-fred.webp"
```

- [Getting Credentials](https://rasa.com/docs/reference/channels/telegram/#getting-credentials)
- [Running on Telegram](https://rasa.com/docs/reference/channels/telegram/#running-on-telegram)
- [Supported Response Attachments](https://rasa.com/docs/reference/channels/telegram/#supported-response-attachments)