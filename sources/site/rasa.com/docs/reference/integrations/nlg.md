# Source: https://rasa.com/docs/reference/integrations/nlg

On this page

## Responding to Requests[​](https://rasa.com/docs/reference/integrations/nlg/#responding-to-requests 'Direct link to Responding to Requests')

### Request Format[​](https://rasa.com/docs/reference/integrations/nlg/#request-format 'Direct link to Request Format')
...
### Response Format[​](https://rasa.com/docs/reference/integrations/nlg/#response-format 'Direct link to Response Format')
...
```
{    "text": "Some text",    "buttons": [],    "image": null,  # string of image URL    "elements": [],    "attachments": [],    "custom": {}}
```

You can choose to provide just text, or a combination of different types of rich responses. Just like [the responses defined in the domain file](https://rasa.com/docs/reference/primitives/responses/), a response needs to contain at the very least either `text` or `custom` to be a valid response.
...
## Configuration[​](https://rasa.com/docs/reference/integrations/nlg/#configuration 'Direct link to Configuration')
...
```
nlg:  url: http://localhost:5055/nlg  #  # You can also specify additional parameters, if you need them:  # headers:  #   my-custom-header: value  # token: "my_authentication_token"  # will be passed as a GET parameter  # basic_auth:  #   username: user  #   password: pass
```
...
- [Responding to Requests](https://rasa.com/docs/reference/integrations/nlg/#responding-to-requests)
 - [Request Format](https://rasa.com/docs/reference/integrations/nlg/#request-format)
 - [Response Format](https://rasa.com/docs/reference/integrations/nlg/#response-format)
- [Configuration](https://rasa.com/docs/reference/integrations/nlg/#configuration)