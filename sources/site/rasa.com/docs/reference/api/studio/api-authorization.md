# Source: https://rasa.com/docs/reference/api/studio/api-authorization

## Introduction[​](https://rasa.com/docs/reference/api/studio/api-authorization/#introduction 'Direct link to Introduction')
...
### Studio-External Client Overview[​](https://rasa.com/docs/reference/api/studio/api-authorization/#studio-external-client-overview 'Direct link to Studio-External Client Overview')
...
**Note**: The instructions below cover both using the default client and creating a new one. If you decide to use existing **studio-external**, login to Keycloak admin and skip directly to [Obtain Client ID and Secret](https://rasa.com/docs/reference/api/studio/api-authorization/#obtaining-client-id-and-secret)

## Creating a New Client ID[​](https://rasa.com/docs/reference/api/studio/api-authorization/#creating-a-new-client-id 'Direct link to Creating a New Client ID')
...
### Client Capability Configuration[​](https://rasa.com/docs/reference/api/studio/api-authorization/#client-capability-configuration 'Direct link to Client Capability Configuration')
...
### Login Settings[​](https://rasa.com/docs/reference/api/studio/api-authorization/#login-settings 'Direct link to Login Settings')

On this page click **Save** to finish.

### Assigning a Role to the Client[​](https://rasa.com/docs/reference/api/studio/api-authorization/#assigning-a-role-to-the-client 'Direct link to Assigning a Role to the Client')
...
1. Go to **Service Accounts Roles** and click on `service-account-studio-external`. **Note:** This service account user may have a different name depending on how you name your client.
 ...
 ![image](https://rasa.com/docs/assets/images/api-keycloak-service-account-3bfb89f22b68f2a931f63ef4ab96ae86.png)
...
### Obtaining Client ID and Secret[​](https://rasa.com/docs/reference/api/studio/api-authorization/#obtaining-client-id-and-secret 'Direct link to Obtaining Client ID and Secret')
...
### Obtain access token[​](https://rasa.com/docs/reference/api/studio/api-authorization/#obtain-access-token 'Direct link to Obtain access token')
...
2. Set **x-www-form-urlencoded** body parameters:
 ...
 - `client_secret`: the secret obtained from [Obtain Client ID and Secret](https://rasa.com/docs/reference/api/studio/api-authorization/#obtaining-client-id-and-secret)
 
 #### Example curl Request[​](https://rasa.com/docs/reference/api/studio/api-authorization/#example-curl-request 'Direct link to Example curl Request')
