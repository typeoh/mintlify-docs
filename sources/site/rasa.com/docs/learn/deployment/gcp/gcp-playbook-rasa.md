# Source: https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa
...
## Kafka Installation[​](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#kafka-installation 'Direct link to Kafka Installation')
...
## Assistant Setup[​](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#assistant-setup 'Direct link to Assistant Setup')
...
### Values File[​](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#values-file 'Direct link to Values File')
...
## Deploy Rasa[​](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#deploy-rasa 'Direct link to Deploy Rasa')
...
## Configure Ingress & TLS Certificate[​](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#configure-ingress--tls-certificate 'Direct link to Configure Ingress & TLS Certificate')
...
- [Kafka Installation](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#kafka-installation)
- [Assistant Setup](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#assistant-setup)
 - [Values File](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#values-file)
- [Deploy Rasa](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#deploy-rasa)
- [Configure Ingress & TLS Certificate](https://rasa.com/docs/learn/deployment/gcp/gcp-playbook-rasa/#configure-ingress--tls-certificate)