# Source: https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio
...
## Studio Setup[​](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#studio-setup 'Direct link to Studio Setup')
...
### Values File[​](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#values-file 'Direct link to Values File')
...
## Deploy studio[​](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#deploy-studio 'Direct link to Deploy studio')
...
## Configure TLS Certificate[​](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#configure-tls-certificate 'Direct link to Configure TLS Certificate')
...
## Next Steps[​](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#next-steps 'Direct link to Next Steps')

- [Set up users and roles for Studio](https://rasa.com/docs/studio/installation/setup-guides/authorization-guide/).
- If you ever need to uninstall Rasa Platform and remove the deployed infrastructure, you can do so by following the instructions in the [Cleanup](https://rasa.com/docs/learn/deployment/azure/azure-playbook-cleanup/) section.

- [Studio Setup](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#studio-setup)
 - [Values File](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#values-file)
- [Deploy studio](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#deploy-studio)
- [Configure TLS Certificate](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#configure-tls-certificate)
- [Next Steps](https://rasa.com/docs/learn/deployment/azure/azure-playbook-studio/#next-steps)